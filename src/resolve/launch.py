...
if __name__ == "__main__":
    ...
    # Frame
    parser.add_argument(
        "-f", "--frame", type=int, help="Frame number to resolve", default=-1
    )
    # Stage
    parser.add_argument(
        "-s",
    ...
    # Yaml
    parser.add_argument(
        "-l", "--yaml_path", type=str, help="Yaml setting path"
    )
    # Extra
    parser.add_argument(
        "-e",
    ...
    # Debug
    parser.add_argument(
        "-d", "--debug", action="store_true", help="Show more detailed log"
    )
